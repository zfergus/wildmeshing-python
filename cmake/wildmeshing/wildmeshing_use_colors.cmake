...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(WILDMESHING_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  wildmeshing_filter_flags(WILDMESHING_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${WILDMESHING_GLOBAL_FLAGS}")
  add_compile_options(${WILDMESHING_GLOBAL_FLAGS})
endif()
