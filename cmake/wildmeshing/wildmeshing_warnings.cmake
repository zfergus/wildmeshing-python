...
if(TARGET wildmeshing::warnings)
  return()
endif()

set(WILDMESHING_WARNING_FLAGS
    -Wall
    -Wextra
    -pedantic
...
add_library(wildmeshing_warnings INTERFACE)
add_library(wildmeshing::warnings ALIAS wildmeshing_warnings)

include(wildmeshing_filter_flags)
wildmeshing_filter_flags(WILDMESHING_WARNING_FLAGS)
target_compile_options(wildmeshing_warnings INTERFACE ${WILDMESHING_WARNING_FLAGS})
